...
<section>
    ...
    try{
        ...
        if ($totalCount == 0) {
            echo '<div class="my_photo"><h4>您还没有上传过图片呢，快去上传一些你喜欢的图片吧！</h4></div>';
        }
        else {
            $pageSize = 5;
            ...
            $sql2 = "select * from travelimage where UID = '$id' limit " . $mark . "," . $pageSize;
                ...
                if (!$row) {
                    ...
                    <div class="my_photo">
                        ...
                        <div class=" my_photo_intro">
                            ...
                            <a href="../php/myPhotoDelete.php?ImageID=<?php echo $ImageID ?>&UID=<?php echo $id ?>">
                                <button class="delete button">Delete</button>
                            </a>
                            <a href="../webpages/upload.php?ImageID=<?php echo $ImageID ?>">
           ...
           <div class="page">
    <a href="my_photo.php?page=<?php echo $prePage; ?>&UID=<?php echo $id; ?>"><<</a>
    <?php
    ...
    ?> <a href="my_photo.php?page=<?php echo $nextPage; ?>&UID=<?php echo $id; ?>">>></a>
           </div>
    <?php
        }
